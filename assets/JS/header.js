    ...
    <div class="grid grid-cols-5 gap-4">
      <div class="col-span-3 flex justify-start gap-4">
        ...
        <a href="fiction.html" class="relative group w-1/3">
          <img src="./assets/Images/portfolio/Fictiontemp/fiction-thumb.jpg" alt="" class="w-full rounded-xl transition-transform duration-300 group-hover:scale-105 group-hover:brightness-75" />
